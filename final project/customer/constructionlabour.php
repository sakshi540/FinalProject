...
<a href="" class="dropdown-item">construction labours</a>
...
<h2 class="text-center">CONSTRUCTION LABOURS</h2>
<div class="row mb-5 pt-3">
<div class="clo-lg-6 col-md-6 col-12">
<img src="../img/constructionlabour.jpg" class="img-fluid">
</div>

<div class="clo-lg-6 col-md-6 col-12">
<h4>Labours Work</h4>
<hr>
<p class="text-justify">A construction laborer or construction worker does physical labor on construction sites. They may prepare sites by cleaning them, loading or unloading materials, and removing hazards. A general laborer may also run some types of equipment, or put together and take apart scaffolding and other temporary structures. They are essential to highway construction, building, and environmental remediation.</p>
<p class="font-weight-bold">construction Labours Responsibilities</p>
<p>1.Operate and care for construction equipment and machines.
<br>2.Prep construction sites by cleaning obstacles and hazards.
<br>3.Load or unload construction materials</p>
<p class="font-weight-bold">construction labours Requirements</p>
<p>1.Must have a valid driver's license.
<br>2.Be at least 18 years of age.
<br>3.Ability to work in all weather.
</p>
</div>
</div>
</div>
