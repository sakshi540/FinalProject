...
<li class="nav-item">
    <a class="nav-link" href=""><b><i class="fa fa-address-card" aria-hidden="true"></i>About</b></a>
    </li>
...
<img src="img/workers img.jpg" class="img-fluid">
</div>
...
<p class="text-justify">Our mission is what drives us to do everything possible to expand human potential. We do that   by creating groundbreaking innovations, by making  our products more sustainably, by building a creative and  diverse global team and by making positive impact in communities we live and work.</p>
...
<p>1.No noisy crowds like conventional system where users have to sit and bid.
<br>2.Excludes general frustration that usually happens while bidding in conventional system.
<br>3.No schedule constraint that means bidder can bid any time and from anywhere.
<br>4.The bidding process can be conducted on a global scale.
</p>
</div>
</div>
</div>
...
<li role="presentation"><a href="constructionlabour.php" tabindex="-1" role="menuitem">construction labours</a></li>
<li role="presentation"><a href="plumbers.php" tabindex="-1" role="menuitem">Plumbers</a></li>
<li role="presentation"><a href="cleaners.php" tabindex="-1" role="menuitem">Cleaners</a></li>
</ul>
</li>
</ul>
</div>
